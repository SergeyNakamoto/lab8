...
import { IProduct } from '../modules/modules.components';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, StarComponent, FontAwesomeModule, RouterModule],
...
export class ProductlistComponent {
  ...
  @ViewChild("conRef", { static: true }) StarComponent!:StarComponent
